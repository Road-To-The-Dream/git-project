        ...
        <div class="shadow mb-4 bg-white rounded border border-primary p-2">
            <div class="container">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#contact" role="tab" aria-controls="contact" aria-selected="true">Контактные данные</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" id="pills-profile-tab" data-toggle="pill" href="#order" role="tab" aria-controls="order" aria-selected="false">Просмотр заказа</a>
                    </li>
                </ul>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control form-control-md" name="last_name" id="last_name" placeholder="Фамилия" value="<?= $data['client'][0]->getLastName(); ?>" autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control form-control-md bfh-phone" name="phone" id="phone" data-format="+380 (dd) dd-dd-ddd" value="<?= $data['client'][0]->getPhone(); ?>">
                                    ...
                                    <div class="shadow mb-4 bg-white rounded border border-primary p-2">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="http://practice/product/index/<?= $data['product'][0]->getId(); ?>" class="text-dark"><p class="f-size-name"></p><?= $data['product'][0]->getName(); ?></a>
                                                    </div>
                                                </div>
