...
<div class="container mb-3">
    ...
    <div class="container">
        <div class="row text-center justify-content-center mt-3 ml-4">
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog"><img class="card-img-top" src="/View/Image/main/Card_image7.jpg"
            ...
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=3"><img class="card-img-top"
            ...
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=4"><img class="card-img-top"
        ...
        <div class="row text-center justify-content-center mt-3 ml-4">
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=5"><img class="card-img-top"
            ...
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=6"><img class="card-img-top"
            ...
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=7"><img class="card-img-top"
            ...
            <div class="col-3">
                <div class="card h-100" style="width: 12rem;">
                    <a href="http://practice/catalog/index/?category=8"><img class="card-img-top"
