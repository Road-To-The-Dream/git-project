    ...
    <div class="row">
        ...
        <div class="col align-self-end">
            <div class="row d-flex justify-content-end">
                <div class="col-auto">
                    <a class='btn btn-primary text-white pl-1 mt-2' onclick="AjaxAddInCart(<?=$value["id"];?>, 'amount_products_in_cart')"><img class="mr-2" src='/View/Image/Cart/Buy.png'>Оформить заказ</a>
                </div>
            </div>
        </div>
    </div>
